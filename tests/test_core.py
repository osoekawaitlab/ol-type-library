...
@pytest.mark.parametrize(argnames=["sut", "test_cases"], argvalues=float_test_cases)
def test_float_mixins(sut: TypeAlias, test_cases: Sequence[Tuple[float, Union[ValueError, float]]]) -> None:
    class TestModel(core.BaseModel):
        value: sut
